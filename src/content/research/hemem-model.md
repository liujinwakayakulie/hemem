...
> **版本状态（v0.2）**：价格与能耗已按 2026 年 8 月北京口径核验（含三对同级车型样本与协会保值率报告，样本明细见文末来源说明）；**保险与保养差额仍为占位值**，平日排队时长仍为假设。核验数据存档于项目 `paper/` 目录，本文不构成购车建议。
...
保养差额占位：油车贵 500 元/年；保险差额占位：电车贵 1,000 元/年（**均待核验**，两项对平衡里程影响约 ±600 km 量级）。
...
| 保养−保险净额（占位） | −500 元 | −500 元 | −500 元 |
| 年净节省 | 2,594 元 | 2,204 元 | 3,642 元 |
| 对比净差价 8,300 元 | **约 3.2 年回本** | 约 3.8 年回本 | 约 2.3 年回本 |
| 平衡日常里程 D* | 约 3,200 km/年 | 约 3,800 km/年 | 约 1,100 km/年 |

三点结论（v0.2，北京口径）：

1. **「省不省」的门槛比想象低得多**：v0.1 占位参数（差价 3 万）下 5,000 km 家庭回不了本；换成 2026 年真实样本（差价 1.16 万、家充 0.47 元），同样家庭**3 年出头就回本**。同级差价的收缩已经把「账面这关」基本打下来了。
2. **家充仍是日常层的根基，但公桩 1 元时代削弱了惩罚**：无家充家庭平衡里程只上移约 600 km（v0.1 时是 2,700 km）——公共快充实际成交价降到 1 元/kWh 后，无家充不再等于「两头失血」。
3. **城际圈作为约束的性质没变，反而更尖锐**：货币上城际层平日单次只省 131 元，而节假日档（排队 1.5–3 h）会把这 131 元吃干净甚至倒挂。**账面回本越来越容易，「敢不敢跑长途」越来越成为唯一的分水岭。**
...
三点：输入是「日常里程 × 长途频次」二维而非单一年里程；城际层引入时间价值与续航折价两类行为修正，且区分平日/节假日档；输出是随家庭参数移动的平衡区间而非单一回本年限。
...
核验数据与样本说明（站内匿名化口径，明细存档于项目 `paper/` 目录）：北京油价/电价为 2026-08 用户核验；车型样本取自车主价格平台 2026-08 车主上报全款均价；节假日排队数据来自国家能源局及交通出行平台 2025 国庆统计（媒体转引存档）。待核验：保险差额、保养差额、平日排队实测分布。
...
> 独立研究者. 家用新能源里程平衡模型（HEMEM）完整说明（v0.2）[EB/OL]. HEMEM 研究站, 2026-08-24. https://hemem.cn/research/hemem-model/
